...
$req = $bdd->prepare("SELECT e.*, u.prenom AS orga_prenom, u.nom AS orga_nom,
...
<body>
    ...
    <div class="contenu-principal">
        ...
        <div class="page-favoris">
            <h1>Mes favoris</h1>
            <p class="sous-texte-favoris">Les événements que vous avez ajoutés à vos favoris.</p>
        </div>

        <section class="grille-events" id="grille-favoris">
            <?php foreach ($evenements as $event): ?>
                <a href="evenement.php?id=<?php echo $event['id']; ?>" class="carte-event carte-favori" data-id="<?php echo $event['id']; ?>">
        ...
        <p id="aucun-favori" class="aucun-event">Vous n'avez pas encore ajouté d'événement aux favoris.</p>
